# Go-reloaded
The objective of this project is making a simple text completion/editing/auto-correction tool.
    ##installation

    #clone this repository
    git clone https://learn.zone01kisumu.ke/git/cliffootieno/go-reloaded
